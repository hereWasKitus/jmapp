...
<form id="form-song-upload" class="form l-song-form js-song-upload " data-layout="song-upload">
  <input type="hidden" name="user_id" value="<?= $user -> ID ?>">
  <h2 class="form__title"><?= __('Upload song', 'jm') ?></h2>

  <div class="form__group">
    <label class="form__label"><?= __('Full name of artist in English', 'jm') ?></label>
    <input required class="input-text" name="song_artist" type="text" placeholder="<?= __('Name', 'jm') ?>">
  </div>

  <div class="form__group">
    <label class="form__label"><?= __('Full name of artist in Hebrew', 'jm') ?></label>
    <input required class="input-text" name="song_artist_he" type="text" placeholder="<?= __('Name', 'jm') ?>">
  </div>

  <div class="form__group form__group--full-width">
    <label class="form__label"><?= __('Artist photo', 'jm') ?></label>
    <div class="account-box" id="#js-drag-area-5">
      <img src="<?= get_template_directory_uri() . '/assets/images/close.png' ?>" alt="close" id="js-remove-image-5" class="remove-btn">
      ...
      <input class="account-box__input" name="song_artist_photo" type="file" id="js-image-input-5" accept=".jpg, .png, .jpeg">
      <img class="account-box__image account-box__image--artist" src="" alt="" id="js-target-image-5">
    </div>
  </div>

  <div class="form__group">
    <label class="form__label"><?= __('Song Name in English', 'jm') ?></label>
    <input required class="input-text" name="song_name" type="text" placeholder="<?= __('Name', 'jm') ?>">
  </div>

  <div class="form__group">
    <label class="form__label"><?= __('Song Name in Hebrew', 'jm') ?></label>
    <input required class="input-text" name="song_name_he" type="text" placeholder="<?= __('Name', 'jm') ?>">
  </div>
  ...
  <div class="form__group form__group--full-width">
    ...
    <div class="account-box" id="#js-drag-area-1">
      ...
      <img class="account-box__image account-box__image--thumb" src="" alt="" id="js-target-image-1">
    </div>
  </div>
  ...
  <div class="form__group form__group--full-width"><button class="btn btn-text btn--dark" type="submit"><?= __('Upload song', 'jm') ?></button></div>
